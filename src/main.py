...
def nik_type_menu():
        ...
        """
        winsound.PlaySound("../assets/sounds/Click.wav", winsound.SND_ASYNC)           
...
def add_get_entry_nik():
        ...
        if len(data_nik) != 10:
                winsound.PlaySound("../assets/sounds/Error.wav", winsound.SND_ASYNC)
                pesan = "NIK harus 10 digit"
                showinfo(title="Warning",message=pesan)
        else:
                ft.nik_validate(data_nik)       
                if ft.nik_validate(data_nik) == False:
                        winsound.PlaySound("../assets/sounds/Success.wav", winsound.SND_ASYNC)
